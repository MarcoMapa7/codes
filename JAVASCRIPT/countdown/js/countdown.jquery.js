(function ($) {
	...
	$.fn.countdown.getTimeRemaining = function (start, end, settings) {
		...
		// Built return object
		remaining.Dias = Math.floor(timeleft / (24 * 60 * 60 * 1000));
		remaining.Horas = Math.floor((timeleft / (24 * 60 * 60 * 1000) - remaining.Dias) * 24);
		remaining.Minutos = Math.floor(((timeleft / (24 * 60 * 60 * 1000) - remaining.Dias) * 24 - remaining.Horas) * 60);
