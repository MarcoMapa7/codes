...
Informe a chave da nota: <input type="text" name="chave" name="chave"size="15" class="cor1" /> 
...
ini_set('display_errors', 1);
	...
	if (@$chave)
	{
		...
		if (file_exists($arquivo)) 
		{
			...
			{
				echo "<h4>Arquivo sem dados de autorizacao!</h4>";
				exit;	
			}
...
//<ide>
	...
	$dSaiEnt = $xml->NFe->infNFe->ide->dhEmi ;    //<dSaiEnt>2011-09-06</dSaiEnt> Data de entrada ou saida da Nota Fiscal
    $dSaiEnt = str_replace('T','-',$dSaiEnt);
	...
	if ($tpAmb != 1)
	{
		echo "<h4>Documento emitido em ambiente de homologacao!</h4>";
		exit;	
	}
...
?>
  <table width="100%" border="0" cellpadding="1" cellspacing="1"> <tr class="cor100">
      <td  align="center" width="0%">STATUS SEFAZ</td>
</tr></table>

 <table width="100%" border="0" cellpadding="1" cellspacing="1">
    <tr class="header-fixa">
      <td align="center"><h3><?=$xMotivo;?></h3></td>
    </tr></table>
...
//===============================================================================================================================================		
//<dest>
     $dest_cnpj =  $xml->NFe->infNFe->dest->CPF;       		        //<CNPJ>01153928000179</CNPJ>
		//<CPF></CPF>
...
?>
  <table width="100%" border="0" cellpadding="1" cellspacing="1">
    <tr class="header-fixa">
      ...
      <td  width="28%"  align="left">Descri&ccedil;&atilde;o dos produto(s)/Servi&ccedil;o(s)</td>
      <td  width="5%"  align="left">CST <a href="cst.html" target="_blank">[?]</a></td>
      <td  width="7%"  align="left">NCM</td>
...
?>
    <tr <?php echo $class ?> >
      ...
      <td><input type="text" name="cst[]"   <?php echo $class ?> size="3" value="<?=$cst?>" readonly="readonly"/></td>
      <td><a href="https://www.qualncm.com.br/ncm/<?php echo $NCM ?>" target="_blank">#</a> <input type="text" <?php echo $class ?> name="NCM[]" size="8" value="<?php echo $NCM ?>" readonly="readonly"/></td>
      <td><a href="https://www.qualcfop.com.br/cfop/<?php echo $CFOP ?>" target="_blank">#</a> <input type="text" <?php echo $class ?> name="CFOP[]" size="4" value="<?php echo $CFOP ?>" readonly="readonly" /></td>
 ...
 <table width="100%" border="0" cellpadding="1" cellspacing="1">
    ...
    <tr class="cor1">
      <td  align="right" width="0%"><input type="text" name="vBC" size="45" class="cor1" value="<?php echO $dest_xNome ?>" readonly="readonly" /></td>
      <td  align="right" width="0%"><input type="text" name="vICMS" size="15" class="cor1" value="<?php echo $dest_cnpj ?>" readonly="readonly" /></td>
      <td  align="right" width="0%"><input type="text" name="vBCST" size="45" class="cor1" value="<?php echo $dest_xLgr ?>" readonly="readonly" /></td>
      <td  align="right" width="0%"><input type="text" name="vST" size="20" class="cor1" value="<?php echo $dest_xMun ?>" readonly="readonly" /></td>
      <td  align="right" width="0%"><input type="text" name="vProd" size="2" class="cor1" value="<?php echo $dest_UF ?>" readonly="readonly" /></td>
    </tr>
  </table>
  <table>
   <tr class="header-fixa"><td>Indicador de Pagamento</td>
   <td>Meio de Pagamento</td> <td>Valor Pago</td> <td>Troco</td>
 </tr> <tr <?php echo $class ?>>
  <td align="center"><?php if($xml->NFe->infNFe->pag->detPag->indPag == 0) { echo "0 - Pagamento a Vista"; } else { echo "1 - Pagamento a Prazo"; }?></td>
  <td align="center"><?=$xml->NFe->infNFe->pag->detPag->tPag;?> <a href="tpag.html" target="_blank"> [?]</a> </td>
  <td align="center"><?=$xml->NFe->infNFe->pag->detPag->vPag;?></td>
  <td align="center"><?=$xml->NFe->infNFe->pag->vTroco;?></td>
  </tr> <tr class="header-fixa"><td colspan=4>Informacoes Complementares</td>
  </tr> <tr <?php echo $class ?>> <td align="center"  colspan=4><?=$xml->NFe->infNFe->infAdic->infCpl;?> </td> </tr>  </table>
  <?php
//===============================================================================================================================================			
		}
		else
		{
			echo "<h4>Nao existe o arquivo com a chave ".$chave." informada!</h4>";
		}
